...
if(isset($_POST['User_submit']))
{
   ...
   $sql="SELECT * From order_detail Where Pick_up_date='".$_POST['Pickdate']."' and Delivery_date='".$_POST['deliverydate']."' and Total_Item='".$_POST['Total_Item']."' and Total_Price='".$_POST['Total_Price']."'";
    $sql1=$db->query($sql);    
    if($sql1->num_rows<=0) {
        ...
        VALUES ('".$USER_ID."','".$Order_Code."','".$USER_Name."','".$_POST['Total_Item']."','".$_POST['Toatl_Price']."','".$_POST['Pickdate']."','".$_POST['deliverydate']."','".$_POST['Contact_No']."','".$_POST['Address']."','No','No')";
          ...
          <div class="row">
             <div class="col-lg-12">
              <div class="table-responsive">
                ...
                <!-- <strong>Total Item :</strong>    <?php echo $Total_Item_Overall;?><br>
    ...
    <div class="card col-lg-6" style="padding: 0px;float: right;">
        ...
        <form action="" method="POST" >
          <div class="row">
              ...
              <div class="form-group col-lg-12">
                <textarea class="form-control" name="Address" required="" placeholder="Please Confirm Address"><?php echo $info_User_Get->Address;?></textarea>
              </div>
              <div class="form-group col-lg-12">
                  <textarea class="form-control" name="Contact_No" required="" placeholder="Please Confirm Phone Number"><?php echo $info_User_Get->Contact_No;?></textarea>
              </div>
