          ...
          <div class="row">
           ...
           <div class="form-group col-lg-12">   
            <div id="Mor_Eve"></div>
              ...
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Ultimate Shoe Cleaner (Rp <?php echo $Data->Dry_Price; ?>)</label>
            ...
            <?php if($Data->Laundry_Price>0){?>
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Premium Shoe Deodorant  (Rp <?php echo $Data->Laundry_Price; ?>)</label>
            ...
            <?php }?>
              ...
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Total Shoes</label>
