...
if(isset($_POST['submit'])){
   extract($_POST);
    ...
    $sql = "SELECT * from user_registration where  User_Name='".$usrname."' and Password='".$Password."' ";
      $info = $db->query($sql);
          if($info->num_rows>0) 
          { 
            $valid = 'Already';
...
<html>
<head>
  <title>Inspirasinee Registration</title>
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form  role="form" method="post" action=""> 
            <div class="form-group">
             ...
             <div class="form-group">
             <label for="psw"><span class="glyphicon glyphicon-phone"></span> Phone Number</label>
